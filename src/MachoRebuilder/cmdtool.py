...
class UnarchiveStaticLib(AR):
    ...
    def __init__(self, thin_input, working_dir=os.getcwd()):
        super(UnarchiveStaticLib, self).__init__(working_dir)
        self.cmd = [self.ar, "-x", thin_input]
...
class AssembleStaticLib(AR):
    ...
    def __init__(self, inputList, output, working_dir=os.getcwd()):
        super(AssembleStaticLib, self).__init__(working_dir)
        self.cmd = [self.ar, "-rcs", output] + inputList
